...
/// 4. overflow : 텍스트가 지정된 공간을 넘어설 경우 처리 방법을 설정한다.
/// 5. maxline : 텍스트의 최대 줄 수를 설정한다. 이 속성을 사용하여 텍스트가 여러 줄로 나뉘도록 할 수 있다.

class TextWidget extends StatelessWidget {

  /// flutter에서는 위젯에 key를 사용하여 고유성을 식별하는데
  ...
  /// 2. 상태유지 : stateful 위젯을 사용할 때, key를 사용하면 올바른 상태를 유지할 수 있게 된다.
