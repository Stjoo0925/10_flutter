        ...
        Form(
          key: _coffeeForm,
            child: Center(
              child: Column(
                children: [
                  CameraWidget(imagePath: viewModel.coffeeItem?.image, setMethod: viewModel.setImage),
                  FormWidget(value : viewModel.coffeeItem?.title ?? "", setValue: viewModel.setTitle),
                  FormWidget(value : viewModel.coffeeItem?.description ?? "", setValue: viewModel.setDescription),
